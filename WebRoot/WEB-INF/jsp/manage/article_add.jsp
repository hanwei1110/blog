...
<div class="ibody">
  ...
  <article>
    <h2 class="about_h">您现在的位置是：<a href="../manage/article">后台首页</a>><a href="1/">写博客</a></h2>
    <div class="index_about">
    <form action="../manage/article_add" method="post" theme="xhtml" enctype="multipart/form-data">
    	<table>
    		<tr>
	    		<td><input name="article.title" style="width:100%;font-size:12pt;text-align:center;" placeholder="请在这里输入标题"/></td>
    		</tr>
    		<tr>
